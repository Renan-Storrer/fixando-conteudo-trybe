...
function addClassTech (evento) {
    let calssTech = document.querySelector('.tech');
    calssTech.classList.remove('tech');
...
input.addEventListener('input', function(evento) {
    let calssTech = document.querySelector('.tech');
    calssTech.innerText = evento.target.value
});
...
myWebpage.addEventListener('dblclick', function() {
    window.location.replace('https://renan-storrer.github.io/');
  });
